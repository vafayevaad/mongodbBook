...
authorRouter.post("/add_author",adminChecker, authmiddleware, multer.single("upload_image"), addAuthor)
authorRouter.put("/update_author/:id",adminChecker, authmiddleware, updateAuthor)
